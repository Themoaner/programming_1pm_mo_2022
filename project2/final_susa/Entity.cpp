        ...
        if (sf::Keyboard::isKeyPressed) {
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::A)) {
                ...
                *CurrentFrame += 0.005 * time;
                ...
                sprite.setTextureRect(sf::IntRect(32 * int(*CurrentFrame), 66 - 2, 33, 32));
                //view->move(-speed,0);
            }
            ...
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::D)) {
                ...
                *CurrentFrame += 0.005 * time;
                ...
                sprite.setTextureRect(sf::IntRect(32 * int(*CurrentFrame), 98 - 2, 32, 32));
                //view->move(speed,0);
            }
            ...
            if ((sf::Keyboard::isKeyPressed(sf::Keyboard::LShift) ||
                ...
                *CurrentFrame += 0.005 * time;
                ...
                sprite.setTextureRect(sf::IntRect(32 * int(*CurrentFrame), 131 - 3, 32, 32));
            }
            if ((sf::Keyboard::isKeyPressed(sf::Keyboard::LShift) ||
                sf::Keyboard::isKeyPressed(sf::Keyboard::RShift)) &&
...
Enemy::Enemy(sf::Image& image, float X, float Y, int W, int H, sf::String Name) : Entity(image, X, Y, W, H, Name) {
    ...
    if (name == "puddle")
    {
        sprite.setTextureRect(sf::IntRect(289, 230, w, h));
    }
}
